; ModuleID = 'for_while-simp.bc'
source_filename = "inputFiles/for_while.cc"
...
32:                                               ; preds = %31, %20
  ...
  %34 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), i32 %33)
  ret i32 0
}
